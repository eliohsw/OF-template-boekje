...
% 3. When custom styles change, regenerate them before latexmk compilation
%    (e.g., `make minted` or `python3 script/mint_injector.py --style style1 --texfile book.tex`)
