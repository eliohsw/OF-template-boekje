...
% See also packages/boekje-fonts.sty
...
\SetFontFromList{mono}{
  ...
  Source Code Pro[
    ...
    FontFace = {sb}{it}{SourceCodePro-SemiboldIt},
    FontFace = {sbx}{n}{SourceCodePro-Semibold},
    FontFace = {sbx}{it}{SourceCodePro-SemiboldIt},
  ],
  JetBrains Mono[
    Scale=1.00,
    ...
    FontFace = {sb}{n}{JetBrainsMono-SemiBold},
    FontFace = {sb}{it}{JetBrainsMono-SemiBoldItalic},
    FontFace = {sbx}{n}{JetBrainsMono-SemiBold},
    FontFace = {sbx}{it}{JetBrainsMono-SemiBoldItalic},
  ],
  Latin Modern Mono
}
